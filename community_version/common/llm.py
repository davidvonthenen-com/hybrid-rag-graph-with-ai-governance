...
def build_grounding_prompt(question: str, graph_hits: List[RetrievalHit], observability: Optional[bool] = False) -> List[Dict[str, str]]:
    ...
    system = (
        "You are a grounded QA assistant. Answer using ONLY the provided Grounding Evidence.\n"
        ...
        "- Only cite the opening tag only (e.g., [G1]). Never use closing tags like [/G1] in your answer.\n"
        "- Don't mention the term Knowledge Graph, Neo4j, or Graph in the answer.\n"
        "\n"
